...
type UserQueryDTO struct {
	...
	Filters map[string]interface{} `json:"filters" binding:"omitempty" example:"{\"status\": 0}"`
	...
	TimeRangeFilters map[string][2]time.Time `json:"time_range_filters" binding:"omitempty" example:"{\"created_at\": [\"2023-01-01T00:00:00Z\", \"2023-12-31T23:59:59Z\"]}"`
